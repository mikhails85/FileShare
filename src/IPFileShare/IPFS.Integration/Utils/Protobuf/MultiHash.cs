...
namespace IPFS.Integration.Utils.Protobuf
{
    ...
    public class MultiHash
    {
        ...
        static MultiHash()
        {
            ...
            HashingAlgorithm.Register("sha3-512", 0x14, 64, () => { return new IPFS.Integration.Utils.Protobuf.Cryptography.SHA3Managed(512); });
    ...
    public class UnknownHashingAlgorithmEventArgs : EventArgs
    {
        ...
        /// </summary>
        public IPFS.Integration.Utils.Protobuf.MultiHash.HashingAlgorithm Algorithm { get; set; }
    }
}